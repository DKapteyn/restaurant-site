  ...
  return (
    <div className={style.mainContainer}>
      <div className={`${style.desktopPic} ${style.pic}`}>
        <Image
          src="/restaurant-site/images/homepage/hero-bg-desktop@2x.jpg"
          alt="plate of food"
          layout="fill"
        />
      </div>
      <div className={`${style.mobileAndTabletPic} ${style.pic}`}>
        <Image
          src="/restaurant-site/images/homepage/hero-bg-tablet@2x.jpg"
          alt="plate of food"
          layout="fill"
        />
      </div>
      <div className={`${style.mobileAndTabletPic} ${style.pic}`}>
        <Image
          src="/restaurant-site/images/homepage/hero-bg-mobile@2x.jpg"
          alt="plate of food"
          layout="fill"
        />
      </div>
